...
{   
    ...
    u8 reg_data_address[2];
    switch (current_axis) {
        case ADXL_IOCTL_SET_AXIS_X:
            reg_data_address[0] = ADXL345_DATAX0;
            reg_data_address[1] = ADXL345_DATAX1;
            break;
        case ADXL_IOCTL_SET_AXIS_Y:
            reg_data_address[0] = ADXL345_DATAY0;
            reg_data_address[1] = ADXL345_DATAY1;
            break;
        case ADXL_IOCTL_SET_AXIS_Z:
            reg_data_address[0] = ADXL345_DATAZ0;
            reg_data_address[1] = ADXL345_DATAZ1;
            break;
        default:
    ...
    if (ret != count) {
        pr_err("Failed to read data from accelerometer\n");
        return ret;
    }
